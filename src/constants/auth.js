...
export const UPDATE_USER_PROFILE_REQUEST = Symbol('auth/UPDATE_USER_PROFILE_REQUEST');
export const UPDATE_USER_PROFILE_SUCCESS = Symbol('auth/UPDATE_USER_PROFILE_SUCCESS');
export const UPDATE_USER_PROFILE_FAILURE = Symbol('auth/UPDATE_USER_PROFILE_FAILURE');
